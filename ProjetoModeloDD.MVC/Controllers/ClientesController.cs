...
namespace ProjetoModeloDD.MVC.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public ActionResult Especias()
        {
            var clienteViewModel = Mapper.Map<IEnumerable<Cliente>, IEnumerable<ClienteViewModel>>(_clienteApp.obterClienteEspecias());
